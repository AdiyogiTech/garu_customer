...
class RemediesAboutScreen extends StatefulWidget {
  RemediesAboutScreen({super.key});

  @override
  State<RemediesAboutScreen> createState() => _RemediesAboutScreenState();
}

class _RemediesAboutScreenState extends State<RemediesAboutScreen> {
 /* final RemediesController controller =
  Get.find<RemediesController>();*/
  final RemediesController controller =
...
@override
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar:HelperAppBar(title:"Dadi Nani Ke Nuskhe",
        displayCart: false,
      displaySearch: false,),

      body: GetBuilder<RemediesController>(
        builder: (controller) {
          ...
          final String image =
              about["image"]?.toString() ?? "";

          // Agar image API se relative path me aa rahi hai
          final String remedyImageUrl = image.isNotEmpty
              ? "$imageUrl/$image"
              : "";
                ...
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      GestureDetector(
                        onTap: () {
                          // String appLink = "https://garu.technolite.in/dadi-nani-ke-nuskhe";
                          String appLink = "https://garu.co.in/dadi-nani-ke-nuskhe";

                          print("AppLink>>>>>>$appLink");

                          Share.share(
                            "🔥 Explore Dadi Nani ke Nuskhe\n\n"
                                "Explore now 👉 $appLink",
                          );
                        },
                        child: Container(
